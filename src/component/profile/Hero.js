            ...
            <div className="row">
                <div className="col-lg-7 col-md-12 col-12 d-flex align-items-center">
                    <div className="about-text">
                        ...
                        <h1 className="animated animated-text">
                            <span className="mr-3">Hey folks, I'm</span>
                                <div className="animated-info">
                                    <span className="animated-item">Wishvanath Sah</span>
                        ...
                        <p>
                        I'm a software engineer based in Hyderabad, [MCA] specialized in building and development(occasionally designing) exceptional websites, applications, product and everything in between, mainly building things for the Web.
                        </p>
                        
                        <div className="custom-btn-group mt-4">
                          <a href="resume/resume.pdf" target="blank" className="btn mr-lg-2 custom-btn custom-btn-no-bg"><i className='uil uil-file-alt'></i> Download Resume</a>
